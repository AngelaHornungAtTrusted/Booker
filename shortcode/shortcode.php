...
<script>
  ...
  EDATE = '<?php echo date('Y-m-d', strtotime('+1 month')); ?>';
...
<div class="row">
    ...
    <div class="col-md-3" <?php echo ($hideSelect === 1) ? "hidden" : ""?>>
        ...
        <input class="br-select" type="date" id="br-event-sdate" name="br-event-sdate" style="padding: 0px;" value="<?= date('Y-m-d') ?>">
    </div>
    <div class="col-md-3" <?php echo ($hideSelect === 1) ? "hidden" : ""?>>
        <label for="br-event-edate" hidden>End Date</label>
        <input class="br-select" type="date" id="br-event-edate" name="br-event-edate" style="padding: 0px;" value="<?= date('Y-m-d', strtotime('+1 month')) ?>">
    </div>
</div>
