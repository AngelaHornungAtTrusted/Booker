...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="email-tab" data-bs-toggle="tab" data-bs-target="#email"
                type="button" role="tab" aria-controls="Email Management" aria-selected="false">Email Management</button>
    </li>
    <li class="nav-item" role="presentation">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="wpbakery-tab" data-bs-toggle="tab" data-bs-target="#wpbakery"
...
<div class="tab-content" id="adminTabsContent">
    ...
    <div class="tab-pane fade" id="email" role="tabpanel" aria-labelledby="email-tab">
        <?php include( plugin_dir_path( __FILE__ ) . 'partial/email/email.php' ); ?>
        <?php wp_enqueue_script('email-js', BR_ADMIN_URL . '/partial/email/email.js', array('jquery')); ?>
    </div>
    ...
    <div class="tab-pane fade" id="wpbakery" role="tabpanel" aria-labelledby="wpbakery-tab">
